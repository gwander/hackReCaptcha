...
$(document).ready(function () {
    ...
    $('#btn_hack').click(function () {
        ...
        var tag = $('#txt_tag').val();
        ////////////
        if (document.getElementById('imageUrl').value.length == 0 || document.getElementById('txt_tag').value.length == 0 || document.getElementById('dimension_x').value.length == 0 || document.getElementById('dimension_y').value.length == 0) {
            alert('You forgot some parameters to input!!!');
